 ...
 * Source: fresh phantomX-Roblox-Dumper output (class-property offsets)
...
namespace Offsets {
    ...
    namespace Camera {
        ...
        inline constexpr uintptr_t CameraType = 0x558;
    ...
    namespace RunService {
        inline constexpr uintptr_t HeartbeatFPS = 0x148;
        inline constexpr uintptr_t HeartbeatTask = 0x68;
    }
